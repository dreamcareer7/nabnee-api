...
module.exports.create_business_category = function (req, res) {
  return new Promise(function (resolve, reject) {
    if (req.body.business_category_name) {
      dbhandler.search_business_category(req.body.business_category_name, req.body.business_category_name_ar).then((resp) => {
        if (resp === "Allowed") {
...
module.exports.read_business_category = function (req, res) {
  return new Promise(function (resolve, reject) {
    if (req.body.status) {
      ...
      resolve(dbhandler.search_business_category_public(req.body.business_category_name))
    }
    else {
      resolve(resObj.content_operation_responses("Insufficient", req));
    }
...
module.exports.delete_business_category = function (req, res) {
  return new Promise(function (resolve, reject) {
    if ((req.body.business_category_id) && (req.body.created_by)) {
      resolve(dbhandler.delete_business_category(req.body.business_category_id, req.body.created_by))
    }
    else {
      resolve(resObj.content_operation_responses("Insufficient", req));
    }
